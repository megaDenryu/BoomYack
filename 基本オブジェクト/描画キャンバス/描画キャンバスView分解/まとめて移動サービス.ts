...
export class まとめて移動サービス {
    ...
    private 選択中の配置物からまとめて動かすIドラッグ移動可能を抽出<座標点T extends Canvas座標Base<座標点T> & 配置物座標点>(選択中配置物: I配置物集約[],ドラッグしたコンポーネント: 付箋枠<座標点T>): Iドラッグ移動可能[] {
    ...
    public 配置物をまとめて移動処理<座標点T extends Canvas座標Base<座標点T> & 配置物座標点>(e: Drag中値, 選択中配置物: I配置物集約[], ドラッグしたコンポーネント: 付箋枠<座標点T>): void {
