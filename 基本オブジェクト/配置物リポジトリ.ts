...
export interface Iグラフ配置先 {
    ...
    描画座標点でadd付箋(pos: 描画座標点, text?: string): 矢印接続可能付箋Old<描画座標点>;
