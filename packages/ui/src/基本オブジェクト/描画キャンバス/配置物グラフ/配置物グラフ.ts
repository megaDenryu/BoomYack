...
export class 配置物グラフ {
    ...
    private 線を介してグラフ情報を埋める():void{
        for (const 折れ線矢印情報 of this.折れ線矢印map.values()){
            const 始点に接続した付箋ID = 折れ線矢印情報.配置物.get始点接続付箋ID();
            if (始点に接続した付箋ID){
            ...
            const 終点に接続した付箋ID = 折れ線矢印情報.配置物.get終点接続付箋ID();
            if (終点に接続した付箋ID){
        ...
        for (const なめらか曲線矢印情報 of this.なめらか曲線矢印map.values()){
            ...
            if (始点に接続した付箋ID){
                ...
                if (始点に接続した付箋情報){
                    ...
                    始点に接続した付箋情報.始点が接続している矢印.push(なめらか曲線矢印情報)
                }
            }
            ...
            if (終点に接続した付箋ID){
                ...
                if (終点に接続した付箋情報){
                    ...
                    終点に接続した付箋情報.終点が接続している矢印.push(なめらか曲線矢印情報)
                }
            }
        }
    }
